...
/**
 *
 * Расширение стандартной модели, новыми функциями
 *
 * @version 1.2
 * @author Ibragimov Renat <info@mrak7.com>
 * @copyright Copyright (c) 2009-10, BESTWEB ltd. www.BESTWEB.ru, 2011 www.PUREANDCO.com
 */
class MY_Model extends CI_Model{
	...
	* @return	array
	*/
	public function find( $id='', $limit='', $from='' ){
		$data = array();
     ...
     * @return array
     */
    public function find_in( $table, $id='', $limit='', $from='' ){
	...
	* @return	array
	*/
	public function find_by( $where='', $limit='', $from='' ){
